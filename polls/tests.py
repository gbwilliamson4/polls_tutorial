...
class QuestionDetailViewTest(TestCase):
    ...
    #     question = create_question(question_text="my Question.", days=-1)
    #     question.choice_text = "option for my question"
    #     self.assertContains(question.question_text, "option for my question")
